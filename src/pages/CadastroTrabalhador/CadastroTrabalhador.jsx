...
import estilos from './CadastroTrabalhador.module.css';
...
function CadastroTrabalhador() {
  ...
  const lidarComTelefone = (evento) => {
    definirDadosFormulario(prev => ({ ...prev, telefonePrestador: formatarTelefone(evento.target.value) }));
  };

  const enviarFormulario = async (evento) => {
    evento.preventDefault();
    const response = await api.post("/Prestador", dadosFormulario)

    const usuario = response.data

    navigate(`/perfil-trabalhador/${usuario}`);
  };
        ...
        <form onSubmit={enviarFormulario} className={estilos.formulario}>
          ...
          <div className={estilos.linha}>
            ...
            <div className={estilos.grupo}>
              ...
              <input
                type="text"
                name="sobrenomePrestador"
                value={dadosFormulario.sobrenomePrestador}
                onChange={lidarComMudanca}
                required
                className={estilos.campo}
              />
          ...
          <div className={estilos.grupoCompleto}>
            ...
            <input
              type="email"
              name="emailPrestador"
              value={dadosFormulario.emailPrestador}
              onChange={lidarComMudanca}
              required
              className={estilos.campo}
            />
          ...
          <div className={estilos.grupoCompleto}>
            ...
            <input
              ...
              value={dadosFormulario.telefonePrestador}
          ...
          <div className={estilos.linha}>
            <div className={estilos.grupo}>
              ...
              <div className={estilos.selectContainer}>
                <select
                  name="generoPrestador"
                  value={dadosFormulario.generoPrestador}
                  onChange={lidarComMudanca}
                  required
            ...
            <div className={estilos.grupo}>
              ...
              <div className={estilos.selectContainer}>
                <select
                  ...
                  value={dadosFormulario.estadoPrestador}
                  onChange={lidarComMudanca}
                  required
                  className={estilos.campoSelect}
                >
          ...
          <div className={estilos.grupoCompleto}>
            ...
            <input
              type="password"
              name="senhaPrestador"
              value={dadosFormulario.senhaPrestador}
              onChange={lidarComMudanca}
              minLength="8"
              required
              className={estilos.campo}
          ...
          <div className={estilos.grupoAcao}>
            <Button text="Cadastrar como Profissional" className={estilos.botao}></Button>
          </div>
